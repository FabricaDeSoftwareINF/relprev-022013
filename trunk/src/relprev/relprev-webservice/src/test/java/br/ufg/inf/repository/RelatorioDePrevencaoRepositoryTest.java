...
public class RelatorioDePrevencaoRepositoryTest {
	...
	public void testSave() {
		this.repository.save(getrRelPrevTest());
	}
	...
	public void testUpdate() {
		final RelPrev relPrevUpdate = getrRelPrevTest();
	...
	public void testDelete() {
		this.repository.delete(getrRelPrevTest());
	}
	...
	public void testFindByLocalIgnoreCase() {
		...
		Assert.assertThat(resultList, Matchers.contains(
				Matchers.allOf(
	...
	public void testFindByDescricaoSituacaoPerigosaContainsIgnoreCase() {
		final List<RelPrev> resultList = this.repository.findByDescricaoSituacaoPerigosaContainsIgnoreCase(this.DESCRICAO);
		Assert.assertThat(resultList.size(), Matchers.is(1));
		Assert.assertThat(resultList, Matchers.contains(
				Matchers.allOf(
	...
	private RelPrev getrRelPrevTest() {
		final Date dataInsercaoAlteracao = getDataInsercaoAlteracao();
		// elo sipaer
