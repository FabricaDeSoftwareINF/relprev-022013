...
public class LoginController {
	...
	public LoginController(final Result result, final Validator validator,
			final UsuarioInfo usuarioInfo) {
		this.result = result;
	...
	public void logar(final String usuario, final String senha) {
		...
		result.redirectTo(RelatorioController.class).ultimosRelatorios();
	}
